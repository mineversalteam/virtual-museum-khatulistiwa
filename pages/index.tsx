            ...
            <div className='detail text-white'>
              <div className='flex h-full justify-center flex-col'>
                ...
                <p className='description py-7'>
                  ...
                  <mark>khatulistiwa dan konteks sosial politik global</mark>,
                  dan dekolonisasi seni. intinya tema projek museum ini
                  berhubungan dengan pembuatan karya seni/sejarah yang ada di
                  negara garis katulistiwa. projek ini tercipta dengan
                  bekerjasama dengan yayasan seni{' '}
                  <mark>Biennale Yogyakarta</mark>.<br />
                  <br /> Museum virtual ini di bangun oleh <mark>MIVUBI</mark> ,
                  yang merupakan team kolaborasi dari Mineversal dan Unibuild
                  Indonesia yang bergerak dalam komunitas Minecraft di
                  Indonesia.{' '}
                </p>
                <div className='pt-2'>
            ...
            <Slider {...settings}>
              <div className='item'>
                ...
                <img
                  ...
                  src='https://media.discordapp.net/attachments/666160887513612329/825408170586800128/IMG-20180317-WA0055-01-01.jpeg'
                  width='230px'
                  height='230'
                  alt=''
                ></img>
          ...
          <div className='grid grid-cols-2'>
            ...
            <div className='flex flex-col h-100 justify-center text-white pl-10'>
              ...
              <p className='description py-7'>
                ...
                ingin mengunjunginya secara online kamu dapat mengikuti step 1
                dan membuka menu multiplayer saat pada game dan menambah server
                dengan ip <mark>museum.minecraft-id.net</mark>
              </p>
              <div className='pt-2'>
                <button className='mr-4 mv-btn btn-blue font-dmSans text-xl'>
                  Tutorial Offline
